...
export default async function RegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#f8f0dc,transparent_32%),linear-gradient(180deg,#fffdf8_0%,#ffffff_100%)] px-6 py-12 text-slate-950">
        ...
        <section className="order-2 lg:order-1">
          <div className="max-w-xl">
            ...
            <p className="mt-4 max-w-lg text-lg leading-8 text-slate-600">
              Start tracking subjects, tasks, and study sessions without
