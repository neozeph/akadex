...
export const metadata: Metadata = {
  title: "About Acadex",
  description: "The story behind Acadex and the mission to help students build calm, confident academic habits.",
}

const pillars = [
  {
    title: "A calmer way to study",
    description: "Acadex helps students make sense of semesters, tasks, and progress without turning school into friction.",
    icon: Compass,
  },
  {
  ...
  },
  {
    ...
    description: "From first-year plans to graduation goals, Acadex grows with each student’s journey.",
    icon: GraduationCap,
  },
]
...
export default function AboutPage() {
  return (
    <PageShell
      eyebrow="About Acadex"
      title="Helping students turn busy semesters into a clear, rewarding path."
      description="Acadex began as a simple idea: academic life should feel guided, not overwhelming. We built a workspace that brings planning, focus, and progress together in one calm place."
    >
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[1.7rem] border border-emerald-200/70 bg-card/85 p-8 shadow-sm dark:border-emerald-500/20">
          ...
          <p className="mt-3 text-base leading-8 text-muted-foreground">
            Acadex exists to make college life feel more intentional. Students should be able to plan their semester, track their growth, and protect their focus without getting buried in scattered tools.
          </p>
          <p className="mt-4 text-base leading-8 text-muted-foreground">
            We believe academic success is shaped by habits, clarity, and steady progress. Acadex is here to support each of those.
          </p>
        </div>
