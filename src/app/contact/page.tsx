...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Reach out to the Akadex team through GitHub or email for questions, feedback, or ideas.",
};
...
export default function ContactPage() {
  return (
    <PageShell
      ...
      actions={
        <>
          <Link href="mailto:josefalanrey@gmail.com">
          ...
          <Link
            href="https://github.com/neozeph/akadex"
            target="_blank"
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-[1.7rem] border border-border/70 bg-background/70 p-8 shadow-sm">
          ...
          <ul className="mt-5 space-y-4 text-sm leading-7 text-muted-foreground">
            ...
            <li>
              • Suggest improvements to planning, GPA tracking, or focus
              sessions.
            </li>
        ...
        <div className="rounded-[1.7rem] border border-emerald-200/70 bg-card/85 p-8 shadow-sm dark:border-emerald-500/20">
          ...
          <p className="mt-3 text-base leading-8 text-muted-foreground">
            Open a GitHub issue for product feedback, or drop us an email and we
            will get back to you as soon as possible.
          </p>
          <div className="mt-6 rounded-[1.2rem] border border-border/70 bg-background/70 p-5">
            <p className="text-sm text-muted-foreground">Email</p>
            <a
              href="mailto:josefalanrey@gmail.com"
              className="mt-2 inline-flex items-center gap-2 text-base font-medium text-foreground hover:text-emerald-600"
            >
              josefalanrey@gmail.com
